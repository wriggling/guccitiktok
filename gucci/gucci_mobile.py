...
def change_username(session_id, device_id, iid, last_username, new_username):
    ...
    if "unique_id" in result :
        if(check_is_changed(last_username, session_id, device_id, iid)):
            return f"{Fore.RESET}[ {Fore.GREEN}+ {Fore.RESET}] {Fore.GREEN}Username change successful."
        else:
            return f"{Fore.RESET}[ {Fore.RED}- {Fore.RESET}] {Fore.RED}Failed to change username: " + str(result)
    else:
        return f"[ {Fore.RED}- {Fore.RESET}] {Fore.RED}Failed to change username: " + str(result)
...
→→→ """
    ...
    session_id = input(f"{Fore.CYAN}{s}")
...
┃    ┗┛┗┛┗┛┗┛┻   ┻ ┗┛┗┛┗┛     ┃
┃━━━━━━━━━━━━━━━━━━━━━━━━━━━━━┃
┃    discord.gg/{Fore.MAGENTA}guccimane{Fore.BLUE}     ┃
┗━━━━━━━━━━━━━━━━━━━━━━━━━━━━━┛
""")
        print(f"{Fore.RESET}[ {Fore.MAGENTA}! {Fore.RESET}] {Fore.BLUE}Your current TikTok username is: {Fore.CYAN}{last_username}")
        new_username = input(f"{Fore.RESET} [ {Fore.MAGENTA}! {Fore.RESET}] {Fore.CYAN}Enter the new username you wish to set: ")
        print(change_username(session_id, device_id, iid,last_username, new_username))

    else:
        print(f"[ {Fore.RED}- {Fore.RESET}] {Fore.RED}Invalid session ID or other error.")
